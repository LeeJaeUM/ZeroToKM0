...
//    public int[] m_animalCount = { 3, 3, 3, 3, 2 };              // 과일 개수별 카드 개수, ex) 과일이 1개 그려진 카드는 총 m_fruitCount[0] = 3개
...
//        {
//            for (int k = 0; k < m_animalCount.Length; k++)
//            {
//                for (int j = 0; j < m_animalCount[k]; j++)
//                {
